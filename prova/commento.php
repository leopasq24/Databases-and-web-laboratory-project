...
if($operazione=="carica"){
    ...
    $stmt_comments= mysqli_prepare($link, "SELECT IdCommento, Username, Contenuto, Data, Ora, Modificato FROM commenta, utente WHERE commenta.IdUtente=utente.IdUtente AND commenta.IdPost=?");
